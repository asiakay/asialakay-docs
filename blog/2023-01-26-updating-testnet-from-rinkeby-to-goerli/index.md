---
slug: updating-testnet-from-rinkeby-to-goerli
authors: asiak
title: Updating Testnet from Rinkeby to Goerli
tags: [web3, javascript, blockchain, sdk]
---

1. create new ~~dapp on alchemy~~ api endpoint url on quicknode to get updated api url ([video walkthrough](https://www.loom.com/share/bdbe5470b4b745819782f6727ba60baa))

1. update React to version 18.0.0

1. update environmental variables in .env file

![update env url](./update-env-file%402x.jpg)
...
![console logged address](./console-address%402x.jpg)

4. comment out or remove `// import { ethers } from "ethers";` from `1-initialize-sdk.js`
...
[https://mumbai.polygonscan.com/address/0x834b5488C4e1fe6Ec2A72996997E52647caD4Dce#code](https://mumbai.polygonscan.com/address/0x834b5488C4e1fe6Ec2A72996997E52647caD4Dce#code)

![polygon testnet transaction](./polygon-explorer-contract%402x.jpg)
